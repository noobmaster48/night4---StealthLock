...
#
EAR_THRESHOLD = 0.05  # <-- Adjust this
...
#
BLINK_TIME_WINDOW = 2.5    # seconds to get 3 blinks
BLINKS_TO_LOCK = 3         # how many blinks to trigger lock
MIN_BLINK_DURATION = 2.5     # minimum frames eye must be closed
...
STATE_IDLE = "IDLE"
STATE_COUNTING = "just moustirizing eyes"
STATE_LOCKED = "LOCK IN"
